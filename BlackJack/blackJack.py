...
def calculate_score(cards):
    ...
    # if user has ace and black jack card then return 0
    if sum(cards) == 21 and len(cards) == 2:
        return 0
    # if user has ace and sum is greater than 21 then replace ace with 1
...
def play_game():
  ...
  # Once the user is done, it's time to let the computer play. The computer should keep drawing cards as long as it has a 
  # score less than 17.
